...
submit_job(){
qsub -cwd -V -N $3-$2-$4 -t 1:100 -j y -o /scratch/TL/pool0/ajalali/ratboost_log -l h_rt=20:: -l mem_free=$5,h_vmem=$5,h_stack=256M /TL/stat_learn/work/ajalali/Network-Classifier/runjob.sh $1/$2/$3 $4 $6
echo $1 $2 $3 $4 $5 $6
}
...
run_for_data_others $1 TCGA-THCA ajcc_pathologic_tumor_stage
run_for_data_others $1 TCGA-THCA tumor_focality

run_for_data_others $1 TCGA-UCEC retrospective_collection
run_for_data_others $1 TCGA-UCEC tumor_status
run_for_data_others $1 TCGA-UCEC vital_status

run_for_data_others $1 TCGA-SARC vital_status
run_for_data_others $1 TCGA-SARC tumor_status
run_for_data_others $1 TCGA-SARC residual_tumor

run_for_data_others $1 TCGA-LGG vital_status
run_for_data_others $1 TCGA-LGG tumor_status
run_for_data_others $1 TCGA-LGG histologic_diagnosis
run_for_data_others $1 TCGA-LGG tumor_grade

run_for_data_others $1 TCGA-BRCA er_status_by_ihc
run_for_data_others $1 TCGA-BRCA ajcc_pathologic_tumor_stage
run_for_data_others $1 TCGA-BRCA ajcc_tumor_pathologic_pt
run_for_data_others $1 TCGA-BRCA ajcc_nodes_pathologic_pn
