...
submit_job(){
qsub -cwd -V -N $2-$3-$4 -t 1:100 -j y -o /scratch/TL/pool0/ajalali/ratboost_log -l h_rt=20:: -l mem_free=$5,h_vmem=$5,h_stack=256M ../runjob.sh $1/$2/$3  $4
echo $1 $2 $3 $4 $5
}

#run_for_data usage: run_for_data working_dir data target
run_for_data(){
    #submit_job $1 $2 $3 'others' 5G
    submit_job $1 $2 $3 'ratboost_logistic_regression' 10G
    #submit_job $1 $2 $3 'ratboost_linear_svc' 5G
    submit_job $1 $2 $3 'ratboost_nu_svc' 10G
}
